        ...
        <div className="postscard" key={key}>
          ...
          <div className="likedislike">
            ...
            <div  className="share-icon-collections">
              {/* Facebook */}
              <a href={`https://www.facebook.com/sharer/sharer.php?u=https%3A%2F%2Fdevelopers.facebook.com%2Fdocs%2Fplugins%2F&amp;src=sdkpreparse"`} target="_blank">
              ...
              {/* Twitter */}
              <a href={`https://twitter.com/intent/tweet?url=${url}&text=${encodeURI(post.Description)}`}
                 target="_blank">
              ...
              {/* Email */}
              <a href={`mailto:info@example.com?&subject=You+have+to+See+this!&cc=&bcc=&body=Check+out+this+site:
              ${url}\n${encodeURI(post.Description)}`} target="_blank">
                <svg className="share-icon" xmlns="http://www.w3.org/2000/svg" style={{width:30}} viewBox="0 0 512 512"
